const ApiKey = " f84e8b08d19c4b29876d3090550327a9";
...
function showTeamInfo(id){
    ...
    .then(response => response.json())
        .then(resJson => {
                ViewModal.innerHTML=`
                <div class="card-image card small"  align="center" >
                        ...
                        <div class="modal-content">
                            <h4>${resJson.name}</h4>
                                <p>
                                    ...
                                    Venue       : ${resJson.venue} <br>
                                    Club Colors : ${resJson.clubColors}<br>
                                    Address     : ${resJson.address} <br>
